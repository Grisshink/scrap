...
bool block_server_read_udp(Exec* exec, Block* block, int argc, FuncArg* argv, FuncArg* return_val, ControlState control_state) {
    ...
    *return_val = DATA_STRING(build_call(exec, "std_udp_server_read", CONST_GC, arg_to_any_string(exec, block, argv[0])));
    return true;
}
...
bool block_server_write_udp(Exec* exec, Block* block, int argc, FuncArg* argv, FuncArg* return_val, ControlState control_state) {
    ...
    *return_val = DATA_INTEGER(build_call(exec, "std_udp_server_write", arg_to_integer(exec, block, argv[0]), arg_to_any_string(exec, block, argv[1]), arg_to_any_string(exec, block, argv[2])));
    return true;
}
...
void register_blocks(Vm* vm) {
    ...
    blockdef_add_argument(sc_server_read_udp, "", "Accepted?", BLOCKCONSTR_STRING);
    ...
    blockdef_add_argument(sc_write_udp, "", "Accepted?", BLOCKCONSTR_STRING);
    blockdef_add_text(sc_write_udp, ", ");
    blockdef_add_argument(sc_write_udp, gettext("Hello, scrap!"), "text?", BLOCKCONSTR_STRING);
    ...
    blockdef_add_argument(sc_client_read_udp, "1024", "buffer size?", BLOCKCONSTR_UNLIMITED);
    ...
    blockdef_add_argument(sc_client_write_udp, gettext("Hello, scrap!"), "text?", BLOCKCONSTR_STRING);
