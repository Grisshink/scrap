...
STD_OBJFILES := $(addprefix $(BUILD_FOLDER),vec.o gc-stand.o std-stand.o scrap-runtime.o)
...
$(BUILD_FOLDER)interpreter.o: src/interpreter.c $(SCRAP_HEADERS)
	$(CC) $(CFLAGS) -c -o $@ $<
$(BUILD_FOLDER)compiler.o: src/compiler.c src/compiler.h src/gc.h src/ast.h
	$(CC) $(CFLAGS) -c -o $@ $<
